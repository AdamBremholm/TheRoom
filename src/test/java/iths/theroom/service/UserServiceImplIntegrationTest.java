...
public class UserServiceImplIntegrationTest {
    ...
    public void setUp() {
        ...
        userEntity1 = new UserEntity("sven", "sve123", "sven@gmail.com"
                , "sve123", "sven", "svensson", new HashSet<>(), null, new AvatarEntity(),"USER", "");

        userEntity2 = new UserEntity("johan", "sve123", "johan@gmail.com"
                , "sve124", "sven", "svensson", new HashSet<>(), null, new AvatarEntity(),"USER", "");


        userEntity3 = new UserEntity("johan", "sve123", "johan@gmail.com"
                , "sve123", "sven", "svensson", new HashSet<>(), null, new AvatarEntity(), "ADMIN, USER", "");
